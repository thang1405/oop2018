...
public class StudentManagement {
    ...
    int number(){ // đếm số phần tử của mảng
        int i=0;
    ...
    void removeStudent(String id) {
        ...
        for(int i=0;i<number();i++) students[i].getInfo();
    }
    ...
    public static void main(String[] args) {
        ...
        Student s1= new Student("tran manh thang 1","17021034","pohajtak@gmail.com");
        Student s2= new Student("tran manh thang 2","17021034","pohajtak@gmail.com");
